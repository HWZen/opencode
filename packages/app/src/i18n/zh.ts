...
export const dict = {
  ...
  "dialog.project.edit.background.hint": "点击或拖拽图片",
  "dialog.project.edit.background.recommended": "建议宽度 2560px",
  ...
  "error.childStore.persistedProjectBackgroundCreateFailed": "创建持久化项目背景缓存失败",
